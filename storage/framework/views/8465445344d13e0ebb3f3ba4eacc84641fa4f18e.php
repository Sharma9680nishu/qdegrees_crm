...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel 5.8 User Roles and Permissions Tutorial')); ?></title>
    <!-- Scripts -->
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php else: ?>
                            ...
                            <li><a class="nav-link" href="<?php echo e(route('export')); ?>">Export Sample</a></li>
                            <li><a class="nav-link" href="/importExportView">Import Leads</a></li>
...
</html><?php /**PATH D:\xampp\htdocs\crm\blog\resources\views/layouts/app.blade.php ENDPATH**/ ?>